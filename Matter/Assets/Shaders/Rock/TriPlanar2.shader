...
Shader "TriPlanar"
{
	Properties
	{
		...
		[NoScaleOffset][Normal]_Stone_01_normal("Stone_01_normal", 2D) = "bump" {}
		_NormalMap("Normal Map", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		uniform sampler2D _Stone_01_normal;
		...
		{
			o.Normal = UnpackScaleNormal( tex2D( _Stone_01_normal, i.uv_texcoord ), _NormalMap );
...
/*ASEBEGIN
Version=17700
1536;0;1536;803;1632.212;346.2534;1.217607;True;False
...
Node;AmplifyShaderEditor.ColorNode;47;-1059.224,-439.5737;Inherit;False;Property;_ColorAlbedo;Color Albedo;2;0;Create;True;0;0;False;0;0.5660378,0.5660378,0.5660378,0;0.6886792,0.6553822,0.5554912,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;51;-955.222,215.0636;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;49;-969.8318,357.5232;Inherit;False;Property;_NormalMap;Normal Map;6;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;48;-620.3724,174.9423;Inherit;True;Property;_Stone_01_normal;Stone_01_normal;5;2;[NoScaleOffset];[Normal];Create;True;0;0;False;0;-1;0e857661d75f075449dae2963cb4495f;0e857661d75f075449dae2963cb4495f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=E6C3ECC1B7495B30D6A077E35D1291AAB7FFA805
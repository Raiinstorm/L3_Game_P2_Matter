...
Shader "Thibaut/Vfx/Extrude"
{
	Properties
	{
		...
		[NoScaleOffset]_TextEmissive("Text Emissive", 2D) = "white" {}
		...
		_AlphaNoise("Alpha Noise", Float) = 9.21
		...
		[HDR]_ColorEmissive("Color Emissive", Color) = (0.8781776,0.5960785,0.9529412,0)
		_EmissiveUV("Emissive UV", Float) = 0
	...
	SubShader
	{
		...
		uniform sampler2D _TextEmissive;
		uniform float4 _ColorEmissive;
		uniform float _EmissiveUV;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult25 = lerp( lerpResult21 , ( tex2D( _MainTextExtrude, i.uv_texcoord ) * _ColorAlbedo ) , saturate( _AnimatedTextAlbedo ));
			...
			float2 uv_TextEmissive102 = i.uv_texcoord;
			half3 gammaToLinear75 = ( clampResult77 + ( ( tex2D( _TextEmissive, uv_TextEmissive102 ) * _ColorEmissive ) * _EmissiveUV ) ).rgb;
			...
			float distanceDepth87 = abs( ( screenDepth87 - LinearEyeDepth( ase_screenPosNorm87.z ) ) / ( _Depth ) );
			float clampResult89 = clamp( distanceDepth87 , 0.0 , 1.0 );
			float depth114 = clampResult89;
			o.Alpha = depth114;
...
/*ASEBEGIN
Version=17700
1536;0;1536;484;6607.223;199.2712;9.546782;True;False
Node;AmplifyShaderEditor.PosVertexDataNode;6;-2734.026,136.4383;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformPositionNode;9;-2446.026,137.4383;Inherit;True;Object;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;42;-1478.253,3360.655;Inherit;False;Property;_NoiseScale;Noise Scale;13;0;Create;True;0;0;False;0;0.041;0.04;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-1475.585,1975.556;Inherit;False;Property;_SizeOutline;Size Outline;15;0;Create;True;0;0;False;0;22.8;22.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;44;-2217.99,2857.326;Inherit;True;Property;_Noise1Text;Noise 1 Text;2;1;[NoScaleOffset];Create;True;0;0;False;0;dc2ef1c1daf6ed745a7813ef508a8257;b4899a8185d80da41917b6d1ceef9d38;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.TexturePropertyNode;43;-2241.683,2589.051;Inherit;True;Property;_Noise2Text;Noise 2 Text;3;1;[NoScaleOffset];Create;True;0;0;False;0;None;dc2ef1c1daf6ed745a7813ef508a8257;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-1876.335,753.8834;Inherit;False;Property;_Spread;Spread;12;0;Create;True;0;0;False;0;0;5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1985.416,475.3562;Inherit;False;Property;_Origin;Origin;11;0;Create;True;0;0;False;0;0;-3.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleNode;52;-1253.853,3366.755;Inherit;False;1;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;50;-2421.134,2221.32;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-1301.456,-260.7968;Inherit;False;Property;_AlphaDarkenRedColor;Alpha Darken Red Color;23;0;Create;True;0;0;False;0;0;3.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;55;-1890.311,2256.861;Inherit;True;FLOAT;1;0;FLOAT;0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.ColorNode;20;-1294.251,-454.0473;Inherit;False;Property;_Color3;Color 3;19;1;[HDR];Create;True;0;0;False;0;1.843137,0.05490196,0,1;0.8021093,0.8586389,0.9716981,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;2;-949.9297,-123.8928;Inherit;False;Property;_Color2;Color 2;18;1;[HDR];Create;True;0;0;False;0;1.924528,0.8045684,0.04538981,1;0.8216463,1.584294,3.706149,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-963.6284,89.6402;Inherit;True;Property;_AlphaDarkenYellowColor;Alpha Darken Yellow Color;24;0;Create;True;0;0;False;0;0;3.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;60;-109.5284,2070.708;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;-148.5228,2996.003;Inherit;False;Property;_AlphaNoise;Alpha Noise;14;0;Create;True;0;0;False;0;9.21;9.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;93;265.7604,1093.217;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;39;219.5171,831.5133;Inherit;True;Property;_MainTextExtrude;MainText Extrude;1;1;[NoScaleOffset];Create;True;0;0;False;0;None;62be4d3b0c28ee741a76ee265799e4d9;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;1;84.41675,239.5397;Inherit;False;Property;_Color1;Color 1;17;1;[HDR];Create;True;0;0;False;0;1.059274,0.8152525,0.8152525,1;1.414214,1.414214,1.414214,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;23;660.7628,1163.412;Inherit;False;Property;_ColorAlbedo;Color Albedo;8;1;[HDR];Create;True;0;0;False;0;0.3672215,0.3499151,0.303131,1;0.2976136,0.2593895,0.6320754,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NegateNode;65;-181.7443,2653.047;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;609.3279,3040.736;Inherit;False;Property;_AlphaExtrude;Alpha Extrude;16;0;Create;True;0;0;False;0;0.64;0.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;116;1228.442,3428.129;Inherit;False;1127.71;338.9824;distance depth;5;84;85;87;89;114;Depth : Extrude < -- > Fault;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;103;1207.671,2176.065;Inherit;True;Property;_TextEmissive;Text Emissive;4;1;[NoScaleOffset];Create;True;0;0;False;0;None;428ac0015c8dfca4fac1209d2c0653d5;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.TFHCRemapNode;69;1587.082,2842.904;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;-8.4;False;4;FLOAT;5.47;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;71;1256.809,1652.021;Inherit;False;Property;_ColorOutine;Color Outine;20;1;[HDR];Create;True;0;0;False;0;6.368628,0.4334669,0,0;5.036642,2.350433,7.125916,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;102;1487.97,2177.68;Inherit;True;Property;_EmissiveUVText;EmissiveUVText;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;108;1559.412,2459.716;Inherit;False;Property;_ColorEmissive;Color Emissive;21;1;[HDR];Create;True;0;0;True;0;0.8781776,0.5960785,0.9529412,0;0.7542472,0.604507,1.059274,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PosVertexDataNode;85;1278.442,3478.129;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;84;1342.494,3652.511;Inherit;False;Property;_Depth;Depth;5;0;Create;True;0;0;False;0;0.1;0.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;87;1564.11,3566.886;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;73;1660.783,1639.185;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;107;1936.594,2412.13;Inherit;False;Property;_EmissiveUV;Emissive UV;22;0;Create;True;0;0;False;0;0;1.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;110;1974.792,2247.698;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;67;-257.8333,2476.183;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;1762.22,1872.553;Inherit;False;Constant;_minLinearHDR;min Linear HDR;19;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;1804.613,1997.61;Inherit;False;Constant;_maxLinearHDR;max Linear HDR;19;0;Create;True;0;0;False;0;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;109;2190.179,2297.057;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;70;520.8772,1969.893;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;77;2147.515,1777.24;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;2,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;89;1901.066,3562.871;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;106;2440.65,1946.289;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;114;2116.15,3560.725;Inherit;False;depth;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;2295.048,1293.77;Inherit;False;Property;_Metallic;Metallic;7;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;115;2711.73,2829.942;Inherit;False;114;depth;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GammaToLinearNode;75;2715.947,1737.218;Inherit;False;1;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NegateNode;113;-2134.454,75.27888;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;100;-2102.914,2185.328;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;2291.469,1450.266;Inherit;True;Property;_Smoothness;Smoothness;6;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GammaToLinearNode;34;2241.36,999.864;Inherit;False;1;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2953.666,2656.362;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Thibaut/Vfx/Extrude;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;False;TreeTransparentCutout;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;113;0;9;2
WireConnection;100;0;50;2
...
ASEEND*/
//CHKSM=D82B2FAD3CD73C579CE7B2DDC72DD6BF42D71B4A
...
public class Guardian : MonoBehaviour
{
	...
	void Start()
    {
		...
		ondeDeChoc.transform.position = AtkRange.transform.position;
		ondeDeChoc.transform.parent = AtkRange.transform;
		ondeDeChoc.DrawCircle(2, 0.2f);


		AtkCollider atkCollider = ondeDeChoc.AddComponent<AtkCollider>();
		atkCollider.player = player.gameObject.GetComponent<Collider>();

		SphereCollider sphereCollider = ondeDeChoc.AddComponent<SphereCollider>();
